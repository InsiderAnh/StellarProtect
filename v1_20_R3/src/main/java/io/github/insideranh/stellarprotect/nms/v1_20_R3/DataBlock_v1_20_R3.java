...
public class DataBlock_v1_20_R3 implements DataBlock {

    private final BlockData blockData;
    @Getter
    private final String blockDataString;

    public DataBlock_v1_20_R3(String blockDataString) {
        this.blockData = Bukkit.createBlockData(blockDataString);
        this.blockDataString = blockDataString;
    }

    public DataBlock_v1_20_R3(Block block) {
        this.blockData = block.getBlockData();
        this.blockDataString = blockData.getAsString();
    }

    public DataBlock_v1_20_R3(BlockState block) {
        this.blockData = block.getBlockData();
        this.blockDataString = blockData.getAsString();
    }
    ...
    public boolean equals(Object obj) {
        if (obj instanceof DataBlock_v1_20_R3) {
            return blockData.equals(((DataBlock_v1_20_R3) obj).blockData);
        }
        return false;
    }
