...
public enum AdjacentType {
    ...
    UP("STICKY_PISTON", "DEAD_BUSH", "MOVING_PISTON", "WHEAT", "LEVER", "TORCH", "SOUL_TORCH",
        ...
        "BAMBOO", "TURTLE_EGG", "CARROTS", "BEACON", "ITEM_FRAME", "GLOW_ITEM_FRAME", "CONDUIT",
        ...
        "CHERRY_BUTTON", "BAMBOO_BUTTON", "MANGROVE_BUTTON",
        ...
        "POTTED_CHERRY_SAPLING", "POTTED_MANGROVE_PROPAGULE", "POTTED_AZALEA_BUSH", "POTTED_FLOWERING_AZALEA_BUSH",
        "POTTED_TORCHFLOWER", "POTTED_PITCHER_PLANT",
        "OAK_DOOR", "SPRUCE_DOOR", "BIRCH_DOOR", "JUNGLE_DOOR", "ACACIA_DOOR", "DARK_OAK_DOOR", "CRIMSON_DOOR", "WARPED_DOOR",
        "CHERRY_DOOR", "BAMBOO_DOOR", "MANGROVE_DOOR", "COPPER_DOOR", "EXPOSED_COPPER_DOOR", "WEATHERED_COPPER_DOOR", "OXIDIZED_COPPER_DOOR",
        ...
        "CHERRY_SAPLING", "MANGROVE_PROPAGULE", "CRIMSON_FUNGUS", "WARPED_FUNGUS",
        ...
        "TORCHFLOWER", "PITCHER_PLANT", "PINK_PETALS", "SPORE_BLOSSOM",
        "OAK_SIGN", "SPRUCE_SIGN", "BIRCH_SIGN", "JUNGLE_SIGN", "ACACIA_SIGN", "DARK_OAK_SIGN", "CRIMSON_SIGN", "WARPED_SIGN",
        "CHERRY_SIGN", "BAMBOO_SIGN", "MANGROVE_SIGN",
        "ANVIL", "CHIPPED_ANVIL", "DAMAGED_ANVIL", "SCAFFOLDING", "KELP", "KELP_PLANT",
        "CAMPFIRE", "SOUL_CAMPFIRE", "LANTERN", "SOUL_LANTERN", "CHAIN",
        "CANDLE", "WHITE_CANDLE", "ORANGE_CANDLE", "MAGENTA_CANDLE", "LIGHT_BLUE_CANDLE", "YELLOW_CANDLE", "LIME_CANDLE",
        "PINK_CANDLE", "GRAY_CANDLE", "LIGHT_GRAY_CANDLE", "CYAN_CANDLE", "PURPLE_CANDLE", "BLUE_CANDLE",
        "BROWN_CANDLE", "GREEN_CANDLE", "RED_CANDLE", "BLACK_CANDLE",
        "GLOW_LICHEN", "HANGING_ROOTS", "SWEET_BERRY_BUSH", "CAVE_VINES", "CAVE_VINES_PLANT",
        "BIG_DRIPLEAF", "SMALL_DRIPLEAF", "POINTED_DRIPSTONE", "AZALEA", "FLOWERING_AZALEA",
    ...
    SIDE(
        ...
        "VINE", "COCOA", "TRIPWIRE", "TRIPWIRE_HOOK", "ITEM_FRAME", "GLOW_ITEM_FRAME", "PAINTING", "LADDER", "LEVER", "SOUL_TORCH", "SOUL_WALL_TORCH",
        "WHITE_BANNER", "ORANGE_BANNER", "MAGENTA_BANNER", "LIGHT_BLUE_BANNER", "YELLOW_BANNER", "LIME_BANNER", "PINK_BANNER", "GRAY_BANNER",
        "LIGHT_GRAY_BANNER", "CYAN_BANNER", "PURPLE_BANNER", "BLUE_BANNER", "BROWN_BANNER", "GREEN_BANNER", "RED_BANNER", "BLACK_BANNER",
        "WHITE_WALL_BANNER", "ORANGE_WALL_BANNER", "MAGENTA_WALL_BANNER", "LIGHT_BLUE_WALL_BANNER", "YELLOW_WALL_BANNER", "LIME_WALL_BANNER", "PINK_WALL_BANNER",
        "GRAY_WALL_BANNER", "LIGHT_GRAY_WALL_BANNER", "CYAN_WALL_BANNER", "PURPLE_WALL_BANNER", "BLUE_WALL_BANNER", "BROWN_WALL_BANNER",
        ...
        "CHERRY_WALL_SIGN", "BAMBOO_WALL_SIGN", "MANGROVE_WALL_SIGN",
        "OAK_BUTTON", "SPRUCE_BUTTON", "BIRCH_BUTTON", "JUNGLE_BUTTON", "ACACIA_BUTTON", "DARK_OAK_BUTTON",
        "CRIMSON_BUTTON", "WARPED_BUTTON", "STONE_BUTTON", "POLISHED_BLACKSTONE_BUTTON",
        "CHERRY_BUTTON", "BAMBOO_BUTTON", "MANGROVE_BUTTON",
