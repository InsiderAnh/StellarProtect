...
public class DataEntity_v1_9_R4 implements DataEntity {
    ...
    public DataEntity_v1_9_R4(Entity entity) {
        readEntityData(entity);
    }

    public DataEntity_v1_9_R4(HashMap<String, Object> data) {
        this.data.putAll(data);
    }

    public DataEntity_v1_9_R4() {
    }
